        ...
        <div>
            <div>
                <div class="card-1 border rounded" id="about_item" style="opacity: 1; transform: translateY(0px);"><svg
                        id="award-svg" width="31" height="31">
                        <use xlink:href="{{ url('assets/icon/sprite.svg#award-svg') }}"></use>
                    </svg>
                    <p class="text-gray-1">Experience</p><span class="text-gray-2">+4 years</span>
                </div>
                <div class="card-1 border rounded" id="about_item" style="opacity: 1; transform: translateY(0px);"><svg
                        id="cloud-svg" width="26" height="26">
                        <use xlink:href="{{ url('assets/icon/sprite.svg#cloud-svg') }}"></use>
                    </svg>
                    <p class="text-gray-1">Completed</p><span class="text-gray-2">{{ $user->project->count() }} project</span>
                </div>
                <div class="card-1 border rounded" id="about_item" style="opacity: 1; transform: translateY(0px);"><svg
                        id="hear-phone-svg" width="20" height="20">
